...
* Table of Contents                                         :TOC_4_gh:noexport:
 ...
 - [[#layer-installation][Layer Installation]]
   - [[#layer][Layer]]
 - [[#backends][Backends]]
   - [[#meghanada-default][Meghanada (default)]]
...
is unintrusive and integrates with =company= and =flycheck=. This is the
default value for the layer variable =java-backend=.
...
**** Issues
 ...
 | Key Binding | Description                                |
 |-------------+--------------------------------------------|
 | ~SPC m i a~ | set all problems for next/prev action      |
 | ~SPC m i b~ | open buffer with problems                  |
 | ~SPC m i c~ | show options with problem corrections      |
 | ~SPC m i e~ | set only errors for next/prev action       |
 | ~SPC m i f~ | set only current file for next/prev action |
 | ~SPC m i n~ | go to next problem                         |
 | ~SPC m i o~ | open buffer with problems                  |
 | ~SPC m i p~ | go to previous problem                     |
 | ~SPC m i w~ | set warnings for next/prev action          |
